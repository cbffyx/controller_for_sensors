...
#define MS5637_COEFFICIENT_NUMBERS									7//8
...
enum ms5637_status ms5637_read_eeprom(void)
{
	...
	if( !ms5637_crc_check( eeprom_coeff, (eeprom_coeff[MS5637_CRC_INDEX]>>12) & 0x000F ) )
...
bool ms5637_crc_check (uint16_t *n_prom, uint8_t crc)
{
    ...
    n_prom[MS5637_CRC_INDEX] = (0x0FFF & (n_prom[MS5637_CRC_INDEX])); 
	n_prom[MS5637_COEFFICIENT_NUMBERS] = 0;
